...
SoundClick2.SoundId = "rbxassetid://6897623656"
...
ImageButton.Image = "http://www.roblox.com/asset/?id=6897623656" -- กำหนดรูปภาพให้กับ ImageButton 
function LoadFunction()    
    ...
    LoadFunction()
    ImageButton.MouseButton1Down:connect(function()
    game:GetService("VirtualInputManager"):SendKeyEvent(true,Enum.KeyCode.LeftCtrl,false,game)
    game:GetService("VirtualInputManager"):SendKeyEvent(false,Enum.KeyCode.LeftCtrl,false,game)
    end)
